...
import { ArrowBigLeft, ArrowLeft, ChevronDown, RefreshCcw } from 'lucide-react'
...
function DropdownFilm() {
    ...
    return (
        ...
        >
            ...
            <div
                className={`
         absolute top-7 left-0 bg-gray-400/10 backdrop-blur-sm shadow-md rounded-xl  
                        ...
                        <div className='w-96 flex justify-between text-center mt-8 mx-4' >
                            ...
                            <div className=''>
                                <button className='flex items-center mx-auto mt-6'>
                                    <span className='ml-2 font-bold'> مشاهده</span>
                                    <ArrowLeft size={18} fontSize={6} />
                                </button>

                                <p className='border-b-4 mt-6 w-96 mx-4 mb-4'></p>
                            </div>
                    </div>
