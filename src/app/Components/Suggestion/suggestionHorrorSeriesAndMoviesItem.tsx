...
function SuggestionHorrorSeriesAndMoviesItem() {
  ...
  return (
    <section className='mt-10'>
                <div className='flex justify-between items-center '>
                    <h2 className='mr-36 text-3xl'> فیلم و سریال های ترسناک</h2>
...
export default SuggestionHorrorSeriesAndMoviesItem