...
function SuggestionActionSeriesAndMoviesItem() {
  ...
  return (
     <section className='mt-10'>
                    <div className='flex justify-between items-center '>
                        <h2 className='mr-36 text-3xl'> فیلم و سریال های اکشن </h2>
...
export default SuggestionActionSeriesAndMoviesItem